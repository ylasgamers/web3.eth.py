...
print("")
print("MultiSend Token/TRC20 Token In Tron With Same Amount")
...
amount = [inputamount, inputamount, inputamount, inputamount, inputamount, inputamount, inputamount, inputamount, inputamount, inputamount]
