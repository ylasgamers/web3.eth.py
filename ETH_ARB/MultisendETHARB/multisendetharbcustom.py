...
ctypes.windll.kernel32.SetConsoleTitleW("Multisender ETH ARB Custom")
print('multisender eth with custom amount')
...
inputamount1 = float(input("Enter amount of eth you want to send recipient1: ")) #ex 1 / 0.1 / 0.001 / 0.0001 / 0.00001
inputamount2 = float(input("Enter amount of eth you want to send recipient2: ")) #ex 1 / 0.1 / 0.001 / 0.0001 / 0.00001
