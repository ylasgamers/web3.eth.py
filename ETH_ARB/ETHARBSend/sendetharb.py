...
ctypes.windll.kernel32.SetConsoleTitleW("ETH ARB Sender")
print('send eth arb to other address')
...
#gasAmount = 21000 #gas limit #change higher if transaction fail
#gasPrice = 30 #gas price #change if transaction fail #realtime gasprice https://etherscan.io/gastracker
chainId = 42161
...
tx = {
    ...
    'nonce': nonce,
    'to': walletRecipient,
    'value': amountToSendETH, #web3.toWei(float(amountToSendETH), 'ether'),
    'gas': gasAmount,
