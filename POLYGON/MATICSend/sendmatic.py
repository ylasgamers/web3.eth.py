...
ctypes.windll.kernel32.SetConsoleTitleW("MATIC Sender")
print('send matic to other address')
...
amountToSendMATIC = web3.toWei(float(input("Enter amount of matic you want to send: ")), 'ether') #ex 1 / 0.1 / 0.001 / 0.0001 / 0.00001
...
tx = {
    ...
    'nonce': nonce,
    'to': walletRecipient,
    'value': amountToSendMATIC, #web3.toWei(float(amountToSendMATIC), 'ether'),
    'gas': gasAmount,
...
time.sleep(30)
print('Current Balance' ,balance_matic, 'MATIC')
