...
ctypes.windll.kernel32.SetConsoleTitleW("Multisender MATIC")
print('multisender matic with same amount')
...
def UpdateBalance():
    ...
    print('Your Balance' ,balance_eth, 'MATIC')
    
UpdateBalance()

inputamount = float(input("Enter amount of matic you want to send: ")) #ex 1 / 0.1 / 0.001 / 0.0001 / 0.00001
