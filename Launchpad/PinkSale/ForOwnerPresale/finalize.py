...
ctypes.windll.kernel32.SetConsoleTitleW("Finalize Presale On Launchpad AIO Blockchain Network")
print('')
print('Finalize Presale On Launchpad Pinksale AIO Blockchain Network')
...
print('')
print('Finalize Presale Success TX-ID Copied To Clipboard')
print(txid)
pc.copy(txid)
