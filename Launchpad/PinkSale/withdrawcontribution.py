...
ctypes.windll.kernel32.SetConsoleTitleW("Withdraw Contribution Presale On Launchpad AIO Blockchain Network")
print('')
print('Withdraw Contribution Presale On Launchpad Pinksale AIO Blockchain Network')
...
print('')
print('Withdraw Contribution Success TX-ID Copied To Clipboard')
print(txid)
pc.copy(txid)
