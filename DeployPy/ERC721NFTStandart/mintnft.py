...
#set title
ctypes.windll.kernel32.SetConsoleTitleW("Mint ERC721NFT Standart On Blockchain Network")
print('')
print('Mint ERC721NFT Standart On Blockchain Network With Python')
print('Mint Can Execute Only Owner Of The Contract Address')
