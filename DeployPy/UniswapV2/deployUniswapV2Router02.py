...
with open("UniswapV2Router02.sol", "r") as file:
    UniswapV2Router02_file = file.read()
...
compiled_sol = compile_standard(
    {
        "language": "Solidity",
        "sources": {"UniswapV2Router02.sol": {"content": UniswapV2Router02_file}},
        "settings": {
             "optimizer": {
             "enabled": bool(True),
             "runs": 200
...
bytecode = compiled_sol["contracts"]["UniswapV2Router02.sol"]["UniswapV2Router02"]["evm"]["bytecode"]["object"]# get abi
abi = json.loads(compiled_sol["contracts"]["UniswapV2Router02.sol"]["UniswapV2Router02"]["metadata"])["output"]["abi"]

#set title
ctypes.windll.kernel32.SetConsoleTitleW("Deploy UniswapV2Router02 On Blockchain Network")
print('')
print('Deploy UniswapV2Router02 On Blockchain Network With Python')
...
factory_addr = web3.toChecksumAddress(input("Enter Contract Factory Address 0x...: "))
wrapped_addr = web3.toChecksumAddress(input("Enter Contract Wrapped Token Address [ Ex: WBNB, WETH, WMATIC ] 0x...: "))
...
gas_tx = Contract.constructor(factory_addr, wrapped_addr).buildTransaction(
    {
        "chainId": chain_id,
...
# build transaction
transaction = Contract.constructor(factory_addr, wrapped_addr).buildTransaction(
    {
        "chainId": chain_id,
        "gas": gasAmount,
        "gasPrice": web3.eth.gas_price,
