...
ctypes.windll.kernel32.SetConsoleTitleW("Swap Sell On DEX Uniswap V3")
print('')
print('Swap Sell On DEX Uniswap V3 With Auto Slippage')
...
def CallMulticall():
    ...
    txSwap = contractrouter.encodeABI(fn_name="exactInputSingle", args=[(tokenaddr, wrapped, 3000, contract_router, amount, 0, 0)])
    ...
    txEncode2 = contractrouter.encodeABI(fn_name="exactInputSingle", args=[(wrapped, tokenaddr, 3000, contract_router, est, 0, 0)])
