...
ctypes.windll.kernel32.SetConsoleTitleW("Swap Buy On DEX Uniswap V3")
print('')
print('Swap Buy On DEX Uniswap V3 With Auto Slippage')
...
contractwrapped = web3.eth.contract(address=wrapped, abi=tokenabi)
...
gas_approve = contractwrapped.functions.approve(contract_router, amount).buildTransaction({
    'chainId': chainId,
    'from': sender,
...
print('')
print('Processing Approve Spender WETH...')
...
#Approve
Approve = contractwrapped.functions.approve(contract_router, amount).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'gas': gasApprove,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
...
gas_tx = contractrouter.functions.exactInputSingle((wrapped, tokenaddr, 3000, sender, amount, 0, 0, deadline)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': amount,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
...
token_tx = contractrouter.functions.exactInputSingle((wrapped, tokenaddr, 3000, sender, amount, 0, 0, deadline)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': amount,
    'gas': gasAmount,
