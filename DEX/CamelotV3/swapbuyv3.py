...
ctypes.windll.kernel32.SetConsoleTitleW("Swap Buy On DEX Camelot V3")
print('')
print('Swap Buy On DEX Camelot V3 With Auto Slippage')
...
gas_tx = contractrouter.functions.exactInputSingle((wrapped, tokenaddr, sender, deadline, amount, 0, 0)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': amount,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
...
token_tx = contractrouter.functions.exactInputSingle((wrapped, tokenaddr, sender, deadline, amount, 0, 0)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': amount,
    'gas': gasAmount,
