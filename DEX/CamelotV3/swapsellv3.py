...
gas_tx = contractrouter.functions.exactInputSingle((wrapped, tokenaddr, sender, deadline, est, 0, 0)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': est,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
...
token_tx = contractrouter.functions.exactInputSingle((tokenaddr, wrapped, sender, deadline, amount, 0, 0)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'gas': gasAmount,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
