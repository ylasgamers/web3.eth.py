...
gas_tx = contractrouter.functions.exactInputSingle((wrapped, tokenaddr, 500, sender, est, 0, 0)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': est,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
...
token_tx = contractrouter.functions.exactInputSingle((tokenaddr, wrapped, 500, sender, amount, 0, 0)).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'gas': gasAmount,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
...
print(txid)
pc.copy(txid)
#swapping wbnb to bnb
print('Swapping WBNB To BNB In 5 Second...')
time.sleep(5)
...
gasWDAmount = web3.eth.estimate_gas(gas_tx)
