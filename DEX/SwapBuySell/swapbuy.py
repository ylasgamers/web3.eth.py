...
ctypes.windll.kernel32.SetConsoleTitleW("Swap Buy On DEX AIO Blockchain Network")
print('')
print('Swap Buy On DEX AIO Blockchain Network With Auto Slippage')
...
gas_tx = contractrouter.functions.swapExactETHForTokensSupportingFeeOnTransferTokens(0, [wrapped, tokenaddr], sender, deadline).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': amount,
...
token_tx = contractrouter.functions.swapExactETHForTokensSupportingFeeOnTransferTokens(0, [wrapped, tokenaddr], sender, deadline).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'value': amount,
    'gas': gasAmount,
