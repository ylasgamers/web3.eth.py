...
ctypes.windll.kernel32.SetConsoleTitleW("Swap Sell On DEX AIO Blockchain Network")
print('')
print('Swap Sell On DEX AIO Blockchain Network With Custom Amount & Auto Slippage')
...
contract_router = web3.toChecksumAddress(input("Enter Contract Address Router DEX : ")) #factory
...
gas_tx = contractrouter.functions.swapExactTokensForETHSupportingFeeOnTransferTokens(amount, 0, [tokenaddr, wrapped], sender, deadline).buildTransaction({
    'chainId': chainId,
    'from': sender,
...
token_tx = contractrouter.functions.swapExactTokensForETHSupportingFeeOnTransferTokens(amount, 0, [tokenaddr, wrapped], sender, deadline).buildTransaction({
    'chainId': chainId,
    'from': sender,
    'gas': gasAmount,
    'gasPrice': web3.eth.gas_price, #web3.toWei(gasPrice,'gwei'),
