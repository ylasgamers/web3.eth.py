...
ctypes.windll.kernel32.SetConsoleTitleW("Multisender BNB")
print('multisender bnb with same amount')
...
inputamount = float(input("Enter amount of bnb you want to send: ")) #ex 1 / 0.1 / 0.001 / 0.0001 / 0.00001
