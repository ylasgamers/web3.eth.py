...
ctypes.windll.kernel32.SetConsoleTitleW("Multisender BNB Custom")
print('multisender bnb with custom amount')
...
contract_address = web3.toChecksumAddress('0x228f053f488d1323d0fbfcc46c4796ed284dd7fb') #Disperse.app
...
inputamount1 = float(input("Enter amount of bnb you want to send recipient1: ")) #ex 1 / 0.1 / 0.001 / 0.0001 / 0.00001
inputamount2 = float(input("Enter amount of bnb you want to send recipient2: ")) #ex 1 / 0.1 / 0.001 / 0.0001 / 0.00001
