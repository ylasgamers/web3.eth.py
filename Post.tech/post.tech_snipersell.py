...
ctypes.windll.kernel32.SetConsoleTitleW("Post.tech Sniper Buy & Sell | Loading...")
os.system("mode con: lines=32766")
os.system("") #allows different colour text to be used
print('')
print('Post.tech Sniper Buy Shares & Sell Shares With Custom Time')
print('You Need Active Account & Export Your Wallet From Post.tech')
print('To Get Your Address & Privatekey From Post.tech')
print('')
